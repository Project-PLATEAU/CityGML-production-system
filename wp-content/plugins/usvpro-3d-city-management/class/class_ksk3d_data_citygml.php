<?php
class ksk3d_data_citygml extends ksk3d_view_list{
  static $tbl = KSK3D_TABLE_DATA;
  static $tbl_ref = [
    'citygml2db_set_attrib'=>array(
  ...
  static function view2(){
    ...
    } else if (isset($_POST["submit"]["citygml2db_set_attrib"])) {
      return static::citygml2db_set_attrib();
    } else if (isset($_POST["submit"]["citygml2DB_check2"])) {
      return static::citygml2DB_check2();
    } else if (isset($_POST["submit"]["citygml2DB_exec"])) {
      return static::citygml2DB_exec();
    } else if (isset($_POST["submit"]["citygml2DB_bgexec"])) {
      return static::citygml2DB_bgexec();
    } else {
      return static::disp();
    }
  }
  ...
  static $button_value = [
    ...
    'citygml2db_set_attrib' => '属性項目の設定',
    'citygml2DB_check2' => '内部データセットへ変換確認',
    'citygml2DB_exec' => '内部データセットへ変換実行',
    'citygml2DB_bgexec' => 'バックグランドで実行',
   ];
...
;
  ...
  static function citygml2DB_exec(){
    $page = 'citygml2DB_exec';
    $form_id = $_POST["form_id"];
    ksk3d_console_log("form_id:".$form_id);
    if (isset($_POST["set_attrib"])){
      $set_attrib = $_POST["set_attrib"];
  ...
  static function citygml2DB_bgexec(){
    $page = 'citygml2DB_bgexec';
    $form_id = $_POST["form_id"];
    ksk3d_console_log("form_id:".$form_id);
    if (isset($_POST["set_attrib"])){
      $set_attrib = $_POST["set_attrib"];
